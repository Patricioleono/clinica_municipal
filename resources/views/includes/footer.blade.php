...
<div class="container mt-3 mb-3">
    <div class="row">
        <div class="col-3 align-items-center">
            <a class="navbar-brand mb-5 mt-5" href="#">
                <img src="img/logoMuniS.png" alt="Logo Clinica" class="w-75" >
            </a>
        </div>
        <div class="col-3">
            <h6>Acerca de Clinica Municipal</h6>
            <ul class="list-group list-group-flush mt-2">
                <a class="link-offset-2 link-offset-3-hover link-underline-secondary link-underline-opacity-0 link-underline-opacity-75-hover text-secondary" href="www.chilechico.cl">
                    Chile Chico
                </a>
